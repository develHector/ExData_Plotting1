...
# Course Project 1
# Plot1.R - File who generates the corresponding plot from url <- 'data/household_power_consumption.txt' ;
# April 2014
# Hector Casavantes
...
# Plot1 is a histogram of power versus ocurrences at specific Global Active Power pero kilowatts level
png( file = "plot1.png" )
